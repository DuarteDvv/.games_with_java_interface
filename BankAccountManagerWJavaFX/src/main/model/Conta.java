...
public abstract class Conta implements Comparable<Conta> {
    ...
    public String toString() {
        ...
        return String.format("%s %d %.2f %s", titular + " || " + numero + " || " + saldo + " || " + formata.format(dataEntrada));
    }
    ...
    public Comparator<Conta> comparadorPorNumero = Comparator.comparingLong(c -> {return c.numero;});

    public Comparator<Conta> comparadorPorData = Comparator.comparing(c -> {return c.dataEntrada;});
